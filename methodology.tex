...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{images/trespassing-detection-pipeline}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{images/background-subtraction-model}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{images/faster-rcnn-pipeline}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{images/anchors}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{images/RPN-architecture}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{images/nms}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{images/classifier}
